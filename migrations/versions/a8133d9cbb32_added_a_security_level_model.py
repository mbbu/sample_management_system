"""Added a Security Level Model

Revision ID: a8133d9cbb32
Revises: 02886a4afc2c
Create Date: 2019-12-12 16:09:49.865474
...
def upgrade():
    ...
    op.add_column('sample', sa.Column('security_level', sa.String(), nullable=True))
