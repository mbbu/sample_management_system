            ...
            <form-wizard @submit.prevent="formSubmit" ref="formContainer"
                ...
                <tab-content :before-change="handleSubmit"
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="projectHead" disabled type="text"
                               v-model="sample.projectHead"/>
                    </div>

                    <!--SAMPLE OWNER-->
                    <div class="form-group" hidden>
                        <label for="sampleOwner"> Sample Owner</label>
                        <input class="form-control" id="sampleOwner" disabled type="text"
                               v-model="sample.sampleOwner"/>
                    </div>
