<template>
    <div class="sidebar">
        <router-link to="/sample">
            <a> <i class="fas fa-vials menu_icon"></i> Samples</a>
        </router-link>
        ...
        <router-link to="/themes">
            <a> <i aria-hidden="true" class="fa fa-trophy menu_icon"> </i> Themes</a>
        </router-link>
        ...
        <router-link to="/freezer">
            <a> <i class="fas fa-snowflake menu_icon"></i> Freezers</a>
        </router-link>

        <router-link to="/chamber">
            <a> <i class="fas fa-box menu_icon"></i> Chambers</a>
        </router-link>

        <router-link to="/rack">
            <a><i class="fas fa-bars menu_icon"></i> Racks</a>
        </router-link>

        <router-link to="/tray">
            <a> <i class="fas fa-th menu_icon"></i> Trays</a>
        </router-link>
