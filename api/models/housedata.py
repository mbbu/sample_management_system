...
class Housedata(BaseModel.db.Model):
    ...
    def __repr__(self):
        return '<< Metadata: (education={0} || employment={1} || married={2} ||' \
               ...
               'animatype={7} || farming_activities={8} || social_economic_data={9} || code={10} || user={11} ) >>' \
            .format(self.education, self.employment, self.marital_status, self.number_of_people,
                    ...
                    self.type_of_animals, self.farming_activities, self.social_economic_data, self.code, self.user_id)
